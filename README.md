...
* [selkies-gstreamer](https://github.com/selkies-project/selkies-gstreamer) has a very neat codebase for gstreamer (see the legacy folder), and I thank the contributors for their work. Their project has various performant optimizations that are also being used here.
