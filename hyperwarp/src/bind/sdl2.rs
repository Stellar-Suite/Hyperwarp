...
lazy_static::lazy_static! {
    ...
    pub static ref SDL_JoystickClose: unsafe extern "C" fn(joystick: *mut SDL_Joystick) -> libc::c_int = unsafe {
        let ptr = libc::dlsym(libc::RTLD_NEXT, b"SDL_JoystickClose_hw_direct\0".as_ptr() as _);
        assert!(!ptr.is_null());
        std::mem::transmute(ptr)
    };
